...
So far this bot only has one command: /snipe
- The /snipe command takes in a number (1 or 2), a username of the person you sniped, and requires that you attach an image when running the command, for proof
